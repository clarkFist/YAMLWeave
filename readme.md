...
## 📖 简介
YAMLWeave是一款专用于C代码自动插桩的工具，提供两种工作模式：

| 模式         | 描述                                                   | 适用场景                                 |
| ------------ | ------------------------------------------------------ | ---------------------------------------- |
| **传统模式** | 直接从C代码注释中的code字段提取桩代码                  | 快速测试、少量插桩                       |
| **分离模式** | 通过锚点标识与YAML配置文件关联，实现桩代码与源代码分离 | 大型项目、多文件场景、需要集中管理桩代码 |
...
直接运行可执行文件即可启动工具，**无需**额外安装Python或其他依赖项。
